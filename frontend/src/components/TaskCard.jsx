        ...
        >
            ...
            <div className="px-4 py-3 grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                <div>
                    ...
                    <p className="text-gb-text mt-0.5 line-clamp-2">{task.description || <span className="text-gb-muted">—</span>}</p>
                </div>
                <div>
                    <span className="text-gb-muted uppercase tracking-wider">CREATED_BY:</span>
                    <p className="text-gb-text mt-0.5">{task.created_by_id ?? '—'}</p>
                </div>
                <div>
                    <span className="text-gb-muted uppercase tracking-wider">ASSIGNEE:</span>
                    <p className="text-gb-text mt-0.5">{task.assignee_id ?? '—'}</p>
                </div>
            </div>
        </div>
    )
